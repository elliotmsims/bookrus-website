...
export default function About() {
    return(
        ...
        <Container>
            <h3>Objective:</h3>
            <p>BooksRUs exists to emphasize the literary contributions of different cultures around the world. The app will include information
