...
export function getCountries(index, sort, search) {
  const request = new XMLHttpRequest();
  const link = testing ? localLink : deployLink;
...
export function getBooks(index, sort, search) {
  const request = new XMLHttpRequest();
  const link = testing ? localLink : deployLink;
...
export function getAuthors(index, sort, search) {
  const request = new XMLHttpRequest();
  const link = testing ? localLink : deployLink;
...
// export function getAuthorFiltered(
//   author_name = null,
