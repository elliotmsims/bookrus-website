...
for i in range(8201, 9801):  # 1, 9801
    ...
    author_request_url = "http://localhost:5000/api/author/" + str(
    ...
    new_book = Books(
        **bdata["data"]["attributes"],
        book_country_id=adata["data"]["attributes"]["author_country_id"]
    )
    ...
    authors_to_books[bdata["data"]["attributes"]["book_author_id"]].append(
        new_book.book_id
    )
