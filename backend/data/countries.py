...
# Get API request
request_url = 'http://api.worldbank.org/v2/countries?format=json'
...
for item in data[1]:
    ...
    if item["region"]["value"] != "Aggregates":
        ...
        if item['latitude'] != '' or item['longitude'] != '':
            ...
            new_country = Country(country_name=item["name"], country_region=item["region"]["value"], country_capital_city=item['capitalCity'])
